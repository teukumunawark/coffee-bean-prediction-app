...
import 'data/api/prediction_api.dart';
import 'data/repositories/data_repository.dart';
import 'data/services/firebase_services.dart';
import 'domain/repositories/domain_repository.dart';
import 'domain/use_case/predict_use_case/create_multi_predict.dart';
import 'domain/use_case/predict_use_case/create_single_predict.dart';
import 'domain/use_case/user_use_case/get_current_user.dart';
...
Future<void> init() async {
  ...
  locator.registerLazySingleton<DomainRepository>(
    () => DataRepositoryIMPL(
        dataSource: locator(), firebaseDataSource: locator()),
  );
